// me despierto.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
void test5() {
    KDTree<int> tree(5);
    vector<vector<int> > elements = rand_elements(54321, 5, 1000, 20, 0);
    for (vector<int> e : elements) {
        tree.insert(e);
    }
...
void test3NN() {
    KDTree<int> tree(3);
    vector<vector<int> > elements = rand_elements(218734, 3, 30, 500, 0);
    for (vector<int> e : elements) {
        tree.insert(e);
    }
...
void test4NN() {
    KDTree<int> tree(4);
    vector<vector<int> > elements = rand_elements(277234, 4, 30, 500, 0);
    for (vector<int> e : elements) {
        tree.insert(e);
    }
...
void testPM2() {
    KDTree<int> tree(2);
    vector<vector<int> > elements = rand_elements(521984, 2, 1000, 20, 0);
    for (vector<int> e : elements) {
        tree.insert(e);
    }
...
void testPM5() {
    KDTree<int> tree(5);
    vector<vector<int> > elements = rand_elements(621234, 5, 3000, 20, 0);
    for (vector<int> e : elements) {
        tree.insert(e);
    }
